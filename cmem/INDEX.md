...
| [testing.md](testing.md) | Unit tests (**70**) + the external conformance corpora (`wasm_mod`, `wasm_wast/testsuite-main`, `wasm_wasi`). **Spec-testsuite snapshot** — positive *and* negative conformance run: i32 459/0, if 240/0, call_indirect 169/0, select 154/0, func 171/0, align 140/0, **table_init 729/0, table_copy 1649/0**, elem 63, data 34/0, **imports 137, linking 100/37, start 11/0**, global 109/1 (f32/f64 2498/2). **2026-07-13:** #15 + host imports #1 (all 3 stages) + start (#3) + full audit-ledger closeout + invoke-by-module-name |
