...
| [testing.md](testing.md) | Unit tests (**65**) + the external conformance corpora (`wasm_mod`, `wasm_wast/testsuite-main`, `wasm_wasi`). **Spec-testsuite snapshot** — positive *and* negative conformance run: i32 459/0, if 240/0, call_indirect 169/0, select 154/0, func 171/0, align 140/0, custom 8/0, binary-leb128 58/1, elem 38/28, func_ptrs 32/0, table_copy 120, table_init 67, global 108/2 (f32/f64 2498/2). Remaining gaps are imported tables/memories + bulk table ops, not core bugs |
