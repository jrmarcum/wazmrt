...
- 🔒 **A GATE MUST BE ABLE TO FAIL, AND THE PROOF MUST TEST THE RIGHT MECHANISM (2026-08-11).** Both
  ...
  - **`zig build size`** — ceilings in `tools/size-ceilings.txt` are EXACT, with no headroom, so growth
    ...
    **978,944**, static lib **1,046,522**, dll **900,608** — all three verified in one run
    (the final conformance pass LOWERED the lib −436; Track D4: +2,560 / +4,946 / +2,560; D3 before it: +3,584 / +4,058 / +3,072; D2: +2,048 / +2,978 / +2,560).
    ...
    re-measured the same way. *(Superseded: 976,384 / 1,042,012 / 898,048, 972,800 / 1,037,954 / 894,976, 970,752 / 1,034,976 / 892,416 and 964,608 / 1,029,730 / 888,832 earlier the same day;
